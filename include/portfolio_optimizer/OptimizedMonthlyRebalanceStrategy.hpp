...
class MarkowitzMonthlyRebalanceStrategy : public RebalanceStrategy {
public:
    explicit MarkowitzMonthlyRebalanceStrategy(std::size_t lookback_days = 60);
...
class RiskParityMonthlyRebalanceStrategy : public RebalanceStrategy {
public:
    explicit RiskParityMonthlyRebalanceStrategy(std::size_t lookback_days = 60);
